...
import '../pulse/pulse_controller.dart';
import '../pulse/widgets/collective_pulse_background.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final pulseState = ref.watch(pulseControllerProvider);
    return Scaffold(
      key: const Key('home_screen'),
      appBar: AppBar(title: const Text('We Are Many')),
      body: CollectivePulseBackground(
        distribution: pulseState.distribution,
        child: ListView(
