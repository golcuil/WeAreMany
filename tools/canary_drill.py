...
def _print(state: str, reason: str | None = None) -> None:
    line = f"canary_drill state={state}"
    if reason:
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Canary drill rehearsal.")
